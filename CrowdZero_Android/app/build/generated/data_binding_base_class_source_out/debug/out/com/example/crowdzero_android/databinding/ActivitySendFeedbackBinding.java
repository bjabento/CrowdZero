...
public final class ActivitySendFeedbackBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivitySendFeedbackBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySendFeedbackBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_send_feedback, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySendFeedbackBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btnF;
      Button btnF = rootView.findViewById(id);
      if (btnF == null) {
        break missingId;
      }

      id = R.id.btnV;
      Button btnV = rootView.findViewById(id);
      if (btnV == null) {
        break missingId;
      }
